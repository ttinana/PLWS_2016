...
import rs.crhov.tijanap.listeners.CallPLWSEvent;
...
public class EntitySOAPeDAOeImpl implements EntitySOAPeDAO, ApplicationEventPublisherAware {
	...
	public void insertListPromene(ArrayOfPrivredniSubjekat listOfPS, JdbcTemplate jdbcTemplate)
				...
				try {
					jdbcTemplate.update(sql,
							new Object[] { mB, myGrupa, convertDateForDBT(datumPromene),
									castToInt(identifikatornacinapromene), identifikatortiparegistracionogpostupka,
									tipPrivrednogSubjekta, new java.sql.Date(utilDate.getTime()) },
		...
		CallPLWSEvent event = new CallPLWSEvent(this);
	...
	/**
	 * Insertuje sve podatke koje je dobio kao rezultat druge funkcije.
	 */
